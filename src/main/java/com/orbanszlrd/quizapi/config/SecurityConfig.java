...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers("/user/quizzes/**").authenticated()
                .antMatchers(HttpMethod.GET, "/api/v1/**").authenticated()
                .antMatchers("/api/v1/**").hasAnyRole("OWNER", "ADMIN")
                .antMatchers("/users/**").hasAnyRole("OWNER", "ADMIN")
                .antMatchers("/categories/**").hasAnyRole("OWNER", "ADMIN")
                .antMatchers(HttpMethod.GET, "/quizzes/**").authenticated()
                .antMatchers("/quizzes/**").hasAnyRole("OWNER", "ADMIN")
                .antMatchers("/questions/**").hasAnyRole("OWNER", "ADMIN")
                .antMatchers("/answers/**").hasAnyRole("OWNER", "ADMIN")
